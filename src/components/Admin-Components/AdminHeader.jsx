...
const AdminHeader = () => {
  ...
  const navigation = [
    { name: "Home", href: "/admin", current: location.pathname === "/admin" },
    {
      name: "Instructors",
      href: "/admin/manageInstructors",
      current: location.pathname === "/admin/manageInstructors",
    },
    {
      name: "Students",
      href: "/admin/manageStudents",
      current: location.pathname === "/admin/manageStudents",
    },
    {
      name: "Courses",
      href: "/admin/manageCourses",
      current: location.pathname === "/admin/manageCourses",
    },
  ];
